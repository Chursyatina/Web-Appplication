namespace WebApi.Tests.SharedData
{
    ...
    public class IngredientControllerFixture : IDisposable
    {
        public IngredientControllerFixture()
        {
            ...
            InitializeDatabase(TestIngredients.AllIngredients);
        }
        ...
        public void InitializeDatabase(IEnumerable<Ingredient> initializingData)
        {
